		...
		public void actionPerformed(ActionEvent e) {
			...
			if     (e.getSource() == but1)     { num += 1; }
				...
				if(num.length() > 0) { 
					...
					JOptionPane.showMessageDialog(Rough.this, outputString, "Calling", JOptionPane.INFORMATION_MESSAGE);
					
				} else {
					
					String outputString = "Please enter phone number";
					JOptionPane.showMessageDialog(Rough.this, outputString, "Error", JOptionPane.ERROR_MESSAGE);
				}
